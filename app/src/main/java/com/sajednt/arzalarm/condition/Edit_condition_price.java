...
public class Edit_condition_price extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_condition_price);
        ...
        texttickername.setText(ic.ticker);
        editPrice.setText(ic.price);
        editMessage.setText(ic.message);
        textcrossprice.setText(ic.price);
        ...
        checkSms.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                sendsms = isChecked;
                Toast.makeText(Edit_condition_price.this, "به زودی ...", Toast.LENGTH_SHORT).show();
        ...
        call.enqueue(new Callback<itemResponse>() {
            ...
            public void onResponse(Call<itemResponse> call, retrofit2.Response<itemResponse> response) {
                ...
                if(response.body().success==1){
                    ...
                    Edit_condition_price.this.finish();
                }
                else{
